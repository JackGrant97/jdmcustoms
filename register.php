        ...
        <form class="col s12 m12 l12" action="includes/signup.inc.php" method="post">
          <div class="row">
            <div class="input-field col s6 m6 l6">
              <input id="first_name" name="FirstName" type="text" pattern="[a-z]" class="validate">
              <label for="first_name">First Name</label>
            </div>
            <div class="input-field col s6 m6 l6">
              <input id="last_name" name="LastName" type="text" pattern="[a-z]" class="validate">
          ...
          <div class="row">
            ...
            <div class="input-field col s6 m6 l6">
              <input id="City" name="City" type="text" pattern="[a-z]"class="validate">
              <label for="City">City</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12 m12 l12">
              <input id="telephone" name="telephone" type="number" pattern="[0-9]" class="validate">
