                  ...
                  <form method="post" action="inventory.php?actionid<?php echo $product['itemID'];?>">
                    <div class="products">
                     	 ...
                     	 <div class="card-content">
                     		 ...
                     		 <p method="post" action="product_template?actionid<?php echo $product['itemID'];?>" class="waves-effect waves-light btn"><a href="product_template.php?id=<?php echo $product['itemID'];?>">More Details</a></p>
                     	 </div>
